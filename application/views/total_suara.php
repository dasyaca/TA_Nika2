                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover" width="80%">
										...
										foreach($kec->result_array() as $c){
										
										?>
                                            <tr>
                                                
                                                <td><a href="<?php echo base_url()."index.php/c_sms/getTotalSuaraKel/".$c['id_kec']; ?>"><?php echo $c['nama_kec']; ?></a></td>
													...
													foreach($kan->result_array() as $b){
														...
														if($c['id_kec']==$b['id_kec']){
															if(!empty($b['ts'])){
																...
																foreach($kandidat->result_array() as $a){
																	?><td><?php
																echo "0"; 
																?></td><?php
																}
