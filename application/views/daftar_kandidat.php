...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="<?php echo base_url(); ?>assets/images/KPU.png" href="images/favicon.png">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Daftar Kandidat</h3> </div>
            </div>
            <!-- End Bread crumb -->
            <!-- Container fluid  -->
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card">
                            <div class="card-body">
								...
								<a href="<?php echo base_url()."index.php/c_sms/tambah_kandidat/"; ?>"><input type="button" class="btn btn-success" value="Tambah Kandidat"/></a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										...
										?>
                                            <tr>
                                                ...
                                                <td><?php echo $i['nama_calon']; ?></td>
                                                <td><?php echo $i['nama_wakil_calon']; ?></td>
                                                <td><img height="75" width="100" src="<?php echo base_url('assets/images/');?><?php echo $i['foto'];?>"></td>
												<td><a href="<?php echo base_url()."index.php/c_sms/edit_kandidat/".$i['id_calon']; ?>"><input type="button" class="btn btn-warning" value="Edit"/></a>    <a href="<?php echo base_url()."index.php/c_sms/edit_foto/".$i['id_calon']; ?>"><input type="button" class="btn btn-success" value="Edit Foto"/></a></td>
