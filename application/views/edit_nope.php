        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Edit No Telp</h3> </div>
            </div>
            <!-- End Bread crumb -->
            <!-- Container fluid  -->
            <div class="container-fluid">
				...
				?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit No Telp Saksi </h4>
									<form method="POST" action="<?php echo base_url('index.php/c_sms/aksi_edit'); ?>">
									<?php foreach($hasil->result_array() as $i){ ?>
									<input type="hidden" name="id_notelp" value="<?php echo $i['id_notelp']; ?>">
										<div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Nama Kecamatan</p>
                                            <div class="col-lg-6">
											<input type="text" class="form-control input-rounded" value="<?php echo $i['nama_kec'];?>" disabled >
                                            </div>
                                        </div>
										<div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Nama Kelurahan</p>
                                            <div class="col-lg-6">
											 <input type="text" class="form-control input-rounded" value="<?php echo $i['nama_kel'];?>" disabled>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Nama TPS</p>
                                            <div class="col-lg-6">
											<input type="text" class="form-control input-rounded" value="<?php echo $i['nama_tps'];?>" disabled>
                                            </div>
                                        </div>
										<div class="col-lg-6">
                                            <p class="text-muted m-b-15 f-s-12">No Telp</p>
                                            <input type="text" class="form-control input-rounded" value="<?php echo $i['no_telp'];?>" id="notelp" name="notelp" required >
                                        </div><br>
										<div class="col-lg-3">
