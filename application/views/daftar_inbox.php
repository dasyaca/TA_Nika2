        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Inbox SMS</h3> </div>
            </div>
            <!-- End Bread crumb -->
            <!-- Container fluid  -->
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Monitoring SMS Saksi</h4>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										...
										?>
                                            <tr>
												...
												<td><a href="<?php echo base_url()."index.php/c_sms/buat_pesan/".$i['id_pesan']; ?>"><input type="button" class="btn btn-success" value="Balas"/></a></td>
										<?php } ?>
                                            </tr>
										<?php } ?>
                                        </tbody>
