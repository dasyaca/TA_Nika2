        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Tambah Data Kandidat</h3> </div>
            </div>
            <!-- End Bread crumb -->
            <!-- Container fluid  -->
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Tambah Data Kandidat</h4>
								
									<form method="POST" action="<?php echo base_url('index.php/c_sms/aksi_tambah_kandidat'); ?>" enctype="multipart/form-data">
									
										<div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">No Urut</p>
                                            <div class="col-lg-6">
											<input type="text" class="form-control input-rounded"  name="no_urut" required>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Nama Calon</p>
                                            <div class="col-lg-6">
											 <input type="text" class="form-control input-rounded"  name="nama_calon" required>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Nama Wakil Calon</p>
                                            <div class="col-lg-6">
											<input type="text" class="form-control input-rounded" name="nama_wakil_calon" required>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Foto</p>
                                            <div class="col-lg-6">
										...
										<div class="col-lg-3">
                                            <input type="submit" class="form-control input-rounded" value="Tambah">
                                        </div>
