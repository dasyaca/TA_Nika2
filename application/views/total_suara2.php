        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card">
						<input type="button" class="btn btn-default" value="Kembali ke Kecamatan" onclick="window.location = '../getTotalSuaraKec';"/>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" width="80%">
										...
										?>
                                            <tr>
                                                <td><a href="<?php echo base_url()."index.php/c_sms/getTotalSuaraTPS/".$i['id_kel']."/".$i['id_kec']; ?>"><?php echo $i['nama_kel']; ?></a></td>
												<td><?php 
												if(empty($i['dpt'])){
													echo "0";
												}
												...
												?></td>
												<?php
												foreach($kan->result_array() as $b){
														
														?><?php 
														if($i['id_kel']==$b['id_kel']){
