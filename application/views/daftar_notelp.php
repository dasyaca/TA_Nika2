        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Daftar No Telp Saksi</h4>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										...
										?>
                                            <tr>
                                                ...
                                                <td><?php echo $i['nama_kel']; ?></td>
                                                <td><?php echo $i['nama_kec']; ?></td>
                                                <td><?php echo $i['no_telp']; ?></td>
												<?php if(empty($i['id_notelp'])){
													$id=0;
												}
													else{
														$id=$i['id_notelp'];
													}												?>
												<td><a href="<?php echo base_url()."index.php/c_sms/edit_nope/".$id."/".$i['id_tps']; ?>"><input type="button" class="btn btn-default" value="Edit"/></a></td>
