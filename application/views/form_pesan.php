        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Balas SMS Saksi</h3> </div>
            </div>
            <!-- End Bread crumb -->
            <!-- Container fluid  -->
            <div class="container-fluid">
				...
				?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Form Balasan SMS</h4>
								<?php foreach($hasil->result_array() as $i){ ?>
									<form method="POST" action="<?php echo base_url('index.php/c_sms/balas_pesan'); ?>">
									<input type="hidden" name="id_calon" value="<?php echo $i['id_pesan'] ?>">
									<input type="hidden" name="nomor" value="<?php echo $i['no_telp'] ?>">
										<div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">No Telp</p>
                                            <div class="col-lg-6">
											<input type="text" class="form-control input-rounded" value="<?php echo $i['no_telp'];?>" name="no" disabled>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Pesan</p>
                                            <div class="col-lg-6">
											 <input type="text" class="form-control input-rounded" value="<?php echo $i['pesan'];?>" name="pesan" disabled>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Balasan Pesan</p>
                                            <div class="col-lg-6">
											<input type="text" class="form-control input-rounded" name="balasan" required>
                                            </div>
                                        </div>
										<div class="col-lg-3">
                                            <input type="submit" class="form-control input-rounded" value="Kirim">
                                        </div>
								<?php } ?>
                                    </form>
