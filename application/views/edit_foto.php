        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Edit Foto Kandidat</h3> </div>
            </div>
            <!-- End Bread crumb -->
            <!-- Container fluid  -->
            <div class="container-fluid">
				...
				?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Foto Kandidat</h4>
								
									<form method="POST" action="<?php echo base_url('index.php/c_sms/aksi_edit_foto'); ?>" enctype="multipart/form-data">

									<?php foreach($query->result_array() as $i){ ?>
										<input type="hidden" name="id_calon" value="<?php echo $i['id_calon']; ?>">
										<img height="250" width="250" src="<?php echo base_url('assets/images/');?><?php echo $i['foto'];?>">
										<?php } ?>
										<div class="col-lg-3">
